...
namespace Компилятор
{
    class Keywords
    {
        ...
        public Keywords()
        {
            ...
            tmp["xor"] = LexicalAnalyzer.xorsy;  // Добавлено xor
            kw[3] = tmp;
            tmp = new Dictionary<string, byte>();
            ...
            tmp["integer"] = LexicalAnalyzer.integersy;  // Добавлено integer
            tmp["real"] = LexicalAnalyzer.realsy;        // Добавлено real
            tmp["char"] = LexicalAnalyzer.charsy;        // Добавлено char
            tmp["boolean"] = LexicalAnalyzer.booleansy;  // Добавлено boolean
            kw[5] = tmp;
            tmp = new Dictionary<string, byte>();
            ...
            tmp["writeln"] = LexicalAnalyzer.writelnsy;  // Добавлено writeln
            kw[9] = tmp;
        }
    }
}